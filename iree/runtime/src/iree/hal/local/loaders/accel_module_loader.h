...
#ifndef IREE_HAL_LOCAL_LOADERS_ACCEL_MODULE_LOADER_H_
#define IREE_HAL_LOCAL_LOADERS_ACCEL_MODULE_LOADER_H_
...
// using the accel module. |instance| will be used for all loaded contexts.
//
// Users may optionally provide additional VM modules that will be linked into
// the context after the accel module such that it can be referenced and before
...
//
// Compiled accel programs that use the user-provided modules are encouraged to
...
// Creates an executable loader that can load compiled IREE VM bytecode modules
// using the accel module. Uses an isolated VM instance.
...
#endif  // IREE_HAL_LOCAL_LOADERS_ACCEL_MODULE_LOADER_H_
