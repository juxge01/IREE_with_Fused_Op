...
#ifndef IREE_HAL_DRIVERS_ACCEL_ACCEL_DEVICE_H_
#define IREE_HAL_DRIVERS_ACCEL_ACCEL_DEVICE_H_
...
// Parameters configuring an iree_hal_accel_device_t.
// Must be initialized with iree_hal_accel_device_params_initialize prior to use.
typedef struct iree_hal_accel_device_params_t {
  ...
  int32_t worker_count; // Not used yet.
  int32_t queue_count;
} iree_hal_accel_device_params_t;
...
#endif  // IREE_HAL_DRIVERS_ACCEL_ACCEL_DEVICE_H_
