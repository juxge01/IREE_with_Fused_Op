...
#ifndef IREE_HAL_DRIVERS_ACCEL_ACCEL_SEMAPHORE_H_
#define IREE_HAL_DRIVERS_ACCEL_ACCEL_SEMAPHORE_H_
...
typedef struct iree_hal_accel_semaphore_state_t {
...
#endif  // IREE_HAL_DRIVERS_ACCEL_ACCEL_SEMAPHORE_H_
