...
if(IREE_TARGET_BACKEND_ACCEL)
  add_subdirectory(${CMAKE_CURRENT_LIST_DIR}/target/Accel target/Accel)
endif()

if(IREE_TARGET_BACKEND_SA16)
	add_subdirectory(${CMAKE_CURRENT_LIST_DIR}/target/SA16 target/SA16)
endif()
