...
llvm::Function *SA16LibraryBuilder::build(StringRef queryFuncName) {
...
llvm::Constant *
SA16LibraryBuilder::buildLibraryV0ImportTable(std::string libraryName) {
  auto &context = module->getContext();
  auto *importTableType = makeImportTableType(context);
  auto *i32Type = llvm::IntegerType::getInt32Ty(context);
...
llvm::Constant *
SA16LibraryBuilder::buildLibraryV0ExportTable(std::string libraryName) {
  auto &context = module->getContext();
  auto *exportTableType = makeExportTableType(context);
  ...
  llvm::Constant *exportAttrs = llvm::Constant::getNullValue(ptrType);
...
llvm::Constant *
SA16LibraryBuilder::buildLibraryV0ConstantTable(std::string libraryName) {
  auto &context = module->getContext();
  auto *constantTableType = makeConstantTableType(context);
  auto *i32Type = llvm::IntegerType::getInt32Ty(context);
  return llvm::ConstantStruct::get(
...
llvm::Constant *
SA16LibraryBuilder::buildLibraryV0SourceTable(std::string libraryName) {
  auto &context = module->getContext();
...
llvm::Constant *SA16LibraryBuilder::buildLibraryV0(std::string libraryName) {
  auto &context = module->getContext();
