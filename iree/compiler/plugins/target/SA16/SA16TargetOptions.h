...
#ifndef IREE_COMPILER_PLUGINS_TARGET_SA16_SA16TARGETOPTIONS_H_
#define IREE_COMPILER_PLUGINS_TARGET_SA16_SA16TARGETOPTIONS_H_
...
struct SA16Target {
  ...
  static constexpr bool DEFAULT_PEELING = false;
  ...
  void copy(const SA16Target &other) {
    triple = other.triple;
    cpu = other.cpu;
  ...
  static std::optional<SA16Target>
  ...
  static std::optional<SA16Target> createForHost();
  ...
  // Enable peeling for loops created during tiling.
  bool peeling = DEFAULT_PEELING;
...
private:
  ...
  friend struct SA16TargetOptions;
  friend struct SA16TargetCLOptions;
};

struct SA16TargetOptions {
...
// Parse into SA16TargetOptions using getTargetOptions().
struct SA16TargetCLOptions {
  ...
  bool linkEmbedded = SA16Target::DEFAULT_LINK_EMBEDDED;
  bool linkStatic = SA16Target::DEFAULT_LINK_STATIC;
  std::string staticLibraryOutputPath;
  bool debugSymbols = SA16Target::DEFAULT_DEBUG_SYMBOLS;
  bool llvmLoopInterleaving = SA16Target::DEFAULT_LOOP_INTERLEAVING;
  bool llvmLoopVectorization = SA16Target::DEFAULT_LOOP_VECTORIZATION;
  bool llvmLoopUnrolling = SA16Target::DEFAULT_LOOP_UNROLLING;
  bool peeling = SA16Target::DEFAULT_PEELING;
  bool llvmSLPVectorization = SA16Target::DEFAULT_SLP_VECTORIZATION;
  SanitizerKind sanitizerKind = SA16Target::DEFAULT_SANITIZER_KIND;
  std::string targetABI;
  llvm::FloatABI::ABIType targetFloatABI = SA16Target::DEFAULT_FLOAT_ABI;
  std::string targetDataLayout = SA16Target::DEFAULT_DATA_LAYOUT;
  unsigned targetVectorWidthInBytes = SA16Target::DEFAULT_VECTOR_WIDTH_IN_BYTES;
  llvm::cl::PowerOf2ByteSize targetMaxStackAllocSizeInBytes =
      SA16Target::DEFAULT_MAX_STACK_ALLOC_SIZE_IN_BYTES;
  std::string enableUkernels = SA16Target::DEFAULT_ENABLE_UKERNELS;
  bool linkUKernelBitcode = SA16Target::DEFAULT_LINK_UKERNEL_BITCODE;
  bool listTargets; // Ignored - used with llvm::cl::ValueDisallowed.

  void bindOptions(OptionsBinder &binder);
  SA16TargetOptions getTargetOptions();
};

} // namespace mlir::iree_compiler::IREE::HAL

#endif // IREE_COMPILER_PLUGINS_TARGET_SA16_SA16TARGETOPTIONS_H_
