...
#define GEN_PASS_DEF_ACCELSELECTLOWERINGSTRATEGYPASS
#include "iree/compiler/Codegen/ACCEL/Passes.h.inc"

namespace {
/// Selects the lowering strategy for a hal.executable.variant operation.
class ACCELSelectLoweringStrategyPass
    : public impl::ACCELSelectLoweringStrategyPassBase<
          ACCELSelectLoweringStrategyPass> {
public:
...
void ACCELSelectLoweringStrategyPass::runOnOperation() {
