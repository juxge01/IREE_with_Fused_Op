...
#define GEN_PASS_DEF_ACCELVERIFYVECTORSIZELEGALITYPASS
#include "iree/compiler/Codegen/ACCEL/Passes.h.inc"

namespace {
struct ACCELVerifyVectorSizeLegalityPass
    : impl::ACCELVerifyVectorSizeLegalityPassBase<
          ACCELVerifyVectorSizeLegalityPass> {
  using impl::ACCELVerifyVectorSizeLegalityPassBase<
      ACCELVerifyVectorSizeLegalityPass>::
      ACCELVerifyVectorSizeLegalityPassBase;
...
void ACCELVerifyVectorSizeLegalityPass::runOnOperation() {
