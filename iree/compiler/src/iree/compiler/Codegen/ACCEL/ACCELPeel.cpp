...
#define DEBUG_TYPE "iree-accel-peel"

namespace mlir::iree_compiler {

#define GEN_PASS_DEF_ACCELPEELPASS
...
class ACCELPeelPass : public impl::ACCELPeelPassBase<ACCELPeelPass> {
public:
...
void ACCELPeelPass::runOnOperation() {
