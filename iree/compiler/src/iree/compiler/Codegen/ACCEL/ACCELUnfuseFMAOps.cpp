...
#define GEN_PASS_DEF_ACCELUNFUSEFMAOPSPASS
...
namespace {
struct ACCELUnfuseFMAOpsPass
    : impl::ACCELUnfuseFMAOpsPassBase<ACCELUnfuseFMAOpsPass> {
...
void ACCELUnfuseFMAOpsPass::runOnOperation() {
  auto funcOp = getOperation();
  auto context = funcOp.getContext();
  RewritePatternSet patterns(&getContext());
  populateAccelUnfusedFMAOpsPassPatterns(context, patterns);
