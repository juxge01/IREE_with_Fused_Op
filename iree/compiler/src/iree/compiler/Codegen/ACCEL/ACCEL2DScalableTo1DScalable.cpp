...
#define GEN_PASS_DEF_ACCEL2DSCALABLETO1DSCALABLEPASS
...
class ACCEL2DScalableTo1DScalablePass
    : public impl::ACCEL2DScalableTo1DScalablePassBase<
          ACCEL2DScalableTo1DScalablePass> {
public:
  using impl::ACCEL2DScalableTo1DScalablePassBase<
      ACCEL2DScalableTo1DScalablePass>::ACCEL2DScalableTo1DScalablePassBase;
...
void ACCEL2DScalableTo1DScalablePass::runOnOperation() {
