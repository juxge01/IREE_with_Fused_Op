...
#define DEBUG_TYPE "iree-accel-mmt4d-vector-lowering"
...
static llvm::cl::opt<bool> clMmt4dUseIntrinsics(
    "iree-codegen-accel-mmt4d-use-intrinsics",
...
#define GEN_PASS_DEF_ACCELMMT4DVECTORLOWERINGPASS
#include "iree/compiler/Codegen/ACCEL/Passes.h.inc"

namespace {
struct ACCELMmt4dVectorLoweringPass
    : public impl::ACCELMmt4dVectorLoweringPassBase<
          ACCELMmt4dVectorLoweringPass> {
  using impl::ACCELMmt4dVectorLoweringPassBase<
      ACCELMmt4dVectorLoweringPass>::ACCELMmt4dVectorLoweringPassBase;
...
void ACCELMmt4dVectorLoweringPass::runOnOperation() {
