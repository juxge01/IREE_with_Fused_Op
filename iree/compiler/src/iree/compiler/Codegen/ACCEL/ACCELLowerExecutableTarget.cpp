...
#define GEN_PASS_DEF_ACCELLOWEREXECUTABLETARGETPASS
...
class ACCELLowerExecutableTargetPass
    : public impl::ACCELLowerExecutableTargetPassBase<
          ACCELLowerExecutableTargetPass> {
public:
  ACCELLowerExecutableTargetPass() = default;
  ACCELLowerExecutableTargetPass(
      const ACCELLowerExecutableTargetPass &pass) {}
...
void ACCELLowerExecutableTargetPass::runOnOperation() {
  ...
  ACCELPipelineOptions pipelineOpts;
