...
#include "iree/compiler/Codegen/ACCEL/Utils.h"
...
#define DEBUG_TYPE "iree-accel-tile-root-and-fuse-producers-consumers"

namespace mlir::iree_compiler {

#define GEN_PASS_DEF_ACCELTILEROOTANDFUSEPRODUCERCONSUMERPASS
...
struct ACCELTileRootAndFuseProducerConsumer
    : impl::ACCELTileRootAndFuseProducerConsumerPassBase<
          ACCELTileRootAndFuseProducerConsumer> {
  using impl::ACCELTileRootAndFuseProducerConsumerPassBase<
      ACCELTileRootAndFuseProducerConsumer>::
      ACCELTileRootAndFuseProducerConsumerPassBase;
...
void ACCELTileRootAndFuseProducerConsumer::runOnOperation() {
...
createACCELTileRootAndFuseProducerConsumerPass(
  ...
  ACCELTileRootAndFuseProducerConsumerPassOptions options;
  options.tilingLevel = tilingLevel;
  options.onlyFuseProducerInputOperands = false;
  return std::make_unique<ACCELTileRootAndFuseProducerConsumer>(options);
}
std::unique_ptr<InterfacePass<mlir::FunctionOpInterface>>
