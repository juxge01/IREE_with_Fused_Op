...
#define DEBUG_TYPE "iree-accel-split-reduction"

namespace mlir::iree_compiler {

#define GEN_PASS_DEF_ACCELSPLITREDUCTIONPASS
...
class ACCELSplitReductionPass
    : public impl::ACCELSplitReductionPassBase<ACCELSplitReductionPass> {
public:
  using impl::ACCELSplitReductionPassBase<
      ACCELSplitReductionPass>::ACCELSplitReductionPassBase;
  explicit ACCELSplitReductionPass(bool fpReductionReordering) {
...
void ACCELSplitReductionPass::runOnOperation() {
...
createACCELSplitReductionPass(const bool enableFpReductionReordering) {
  return std::make_unique<ACCELSplitReductionPass>(
      enableFpReductionReordering);
}
} // namespace mlir::iree_compiler
