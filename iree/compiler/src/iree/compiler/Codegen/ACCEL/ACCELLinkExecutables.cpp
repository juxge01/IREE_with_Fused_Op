...
#define GEN_PASS_DEF_ACCELLINKEXECUTABLESPASS
#include "iree/compiler/Codegen/ACCEL/Passes.h.inc"

namespace {

struct ACCELLinkExecutablesPass
    : public impl::ACCELLinkExecutablesPassBase<ACCELLinkExecutablesPass> {
  using impl::ACCELLinkExecutablesPassBase<
      ACCELLinkExecutablesPass>::ACCELLinkExecutablesPassBase;
