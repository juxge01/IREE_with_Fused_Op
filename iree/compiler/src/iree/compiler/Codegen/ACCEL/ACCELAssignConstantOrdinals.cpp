...
#define GEN_PASS_DEF_ACCELASSIGNCONSTANTORDINALSPASS
#include "iree/compiler/Codegen/ACCEL/Passes.h.inc"

namespace {

struct ACCELAssignConstantOrdinalsPass
    : public impl::ACCELAssignConstantOrdinalsPassBase<
          ACCELAssignConstantOrdinalsPass> {
