...
#define GEN_PASS_DEF_ACCELASSIGNIMPORTORDINALSPASS
#include "iree/compiler/Codegen/ACCEL/Passes.h.inc"

namespace {

struct ACCELAssignImportOrdinalsPass
    : public impl::ACCELAssignImportOrdinalsPassBase<
          ACCELAssignImportOrdinalsPass> {
