...
#define DEBUG_TYPE "iree-accel-vector-transpose-lowering"

namespace mlir::iree_compiler {

#define GEN_PASS_DEF_ACCELVECTORTRANSPOSELOWERINGPASS
...
class ACCELVectorTransposeLoweringPass
    : public impl::ACCELVectorTransposeLoweringPassBase<
          ACCELVectorTransposeLoweringPass> {
public:
  using impl::ACCELVectorTransposeLoweringPassBase<
      ACCELVectorTransposeLoweringPass>::
      ACCELVectorTransposeLoweringPassBase;
...
void ACCELVectorTransposeLoweringPass::runOnOperation() {
