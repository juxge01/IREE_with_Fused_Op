...
#define DEBUG_TYPE "iree-accel-tile-and-fuse"

namespace mlir::iree_compiler {

#define GEN_PASS_DEF_ACCELTILEANDFUSEPASS
...
struct ACCELTileAndFusePass
    : impl::ACCELTileAndFusePassBase<ACCELTileAndFusePass> {
  using impl::ACCELTileAndFusePassBase<
      ACCELTileAndFusePass>::ACCELTileAndFusePassBase;
  explicit ACCELTileAndFusePass(int64_t tilingLevel) {
...
void ACCELTileAndFusePass::runOnOperation() {
...
createACCELTileAndFusePass(int64_t tilingLevel) {
  return std::make_unique<ACCELTileAndFusePass>(tilingLevel);
}
