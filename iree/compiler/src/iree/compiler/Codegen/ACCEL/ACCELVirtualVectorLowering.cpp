...
#define DEBUG_TYPE "iree-accel-virtual-vector-lowering"

namespace mlir::iree_compiler {

#define GEN_PASS_DEF_ACCELVIRTUALVECTORLOWERINGPASS
#include "iree/compiler/Codegen/ACCEL/Passes.h.inc"

namespace {
class ACCELVirtualVectorLoweringPass
    : public impl::ACCELVirtualVectorLoweringPassBase<
          ACCELVirtualVectorLoweringPass> {
public:
  using impl::ACCELVirtualVectorLoweringPassBase<
      ACCELVirtualVectorLoweringPass>::ACCELVirtualVectorLoweringPassBase;
...
void ACCELVirtualVectorLoweringPass::runOnOperation() {
