...
#define GEN_PASS_DEF_ACCELSYNCHRONIZESYMBOLVISIBILITYPASS
...
struct ACCELSynchronizeSymbolVisibilityPass
    : public impl::ACCELSynchronizeSymbolVisibilityPassBase<
          ACCELSynchronizeSymbolVisibilityPass> {
