...
#ifndef VERILATED_VAXI_SA16_GROUP_PROCESSING_ELEMENT_64_H_
#define VERILATED_VAXI_SA16_GROUP_PROCESSING_ELEMENT_64_H_  // guard

#include "verilated.h"

class Vaxi_sa16__Syms;

class Vaxi_sa16_group_processing_element_64 final : public VerilatedModule {
  public:
    ...
    VL_IN(io_inputC_0,18,0);
    VL_IN(io_inputC_1,18,0);
    VL_IN(io_inputC_2,18,0);
    VL_IN(io_inputC_3,18,0);
    VL_OUT(io_outputC_0,18,0);
    VL_OUT(io_outputC_1,18,0);
    VL_OUT(io_outputC_2,18,0);
    VL_OUT(io_outputC_3,18,0);
    IData/*18:0*/ __PVT__io_outputC_0_REG;
    IData/*18:0*/ __PVT__io_outputC_1_REG;
    IData/*18:0*/ __PVT__io_outputC_2_REG;
    IData/*18:0*/ __PVT__io_outputC_3_REG;
    IData/*19:0*/ __PVT__vectorProcessingElementVector_0_0__DOT__io_outputC_REG;
    IData/*19:0*/ __PVT__vectorProcessingElementVector_0_1__DOT__io_outputC_REG;
    IData/*19:0*/ __PVT__vectorProcessingElementVector_0_2__DOT__io_outputC_REG;
    IData/*19:0*/ __PVT__vectorProcessingElementVector_0_3__DOT__io_outputC_REG;

    // INTERNAL VARIABLES
    Vaxi_sa16__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vaxi_sa16_group_processing_element_64(Vaxi_sa16__Syms* symsp, const char* name);
    ~Vaxi_sa16_group_processing_element_64();
    VL_UNCOPYABLE(Vaxi_sa16_group_processing_element_64);
