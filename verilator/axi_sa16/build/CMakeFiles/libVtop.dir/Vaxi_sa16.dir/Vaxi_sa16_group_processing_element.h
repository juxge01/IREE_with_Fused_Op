...
#ifndef VERILATED_VAXI_SA16_GROUP_PROCESSING_ELEMENT_H_
#define VERILATED_VAXI_SA16_GROUP_PROCESSING_ELEMENT_H_  // guard

#include "verilated.h"

class Vaxi_sa16__Syms;

class Vaxi_sa16_group_processing_element final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vaxi_sa16_group_processing_element(Vaxi_sa16__Syms* symsp, const char* name);
    ~Vaxi_sa16_group_processing_element();
    VL_UNCOPYABLE(Vaxi_sa16_group_processing_element);
