...
VL_ATTR_COLD void Vaxi_sa16_group_processing_element___ctor_var_reset(Vaxi_sa16_group_processing_element* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxi_sa16__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vaxi_sa16_group_processing_element___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->io_outputC_0 = VL_RAND_RESET_I(16);
    vlSelf->io_outputC_1 = VL_RAND_RESET_I(16);
    vlSelf->io_outputC_2 = VL_RAND_RESET_I(16);
    vlSelf->io_outputC_3 = VL_RAND_RESET_I(16);
    vlSelf->__PVT__REG_0 = VL_RAND_RESET_I(8);
    vlSelf->__PVT__io_outputC_0_REG = VL_RAND_RESET_I(16);
    vlSelf->__PVT__io_outputC_1_REG = VL_RAND_RESET_I(16);
    vlSelf->__PVT__io_outputC_2_REG = VL_RAND_RESET_I(16);
    vlSelf->__PVT__io_outputC_3_REG = VL_RAND_RESET_I(16);
    vlSelf->__PVT__vectorProcessingElementVector_0_0__DOT__registerB_0 = VL_RAND_RESET_I(8);
    vlSelf->__PVT__vectorProcessingElementVector_0_0__DOT__io_outputC_REG = VL_RAND_RESET_I(16);
    ...
    vlSelf->__PVT__vectorProcessingElementVector_0_1__DOT__io_outputC_REG = VL_RAND_RESET_I(16);
    ...
    vlSelf->__PVT__vectorProcessingElementVector_0_2__DOT__io_outputC_REG = VL_RAND_RESET_I(16);
    ...
    vlSelf->__PVT__vectorProcessingElementVector_0_3__DOT__io_outputC_REG = VL_RAND_RESET_I(16);
