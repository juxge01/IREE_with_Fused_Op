...
#ifndef VERILATED_VAXI_SA16_GROUP_PROCESSING_ELEMENT_32_H_
#define VERILATED_VAXI_SA16_GROUP_PROCESSING_ELEMENT_32_H_  // guard

#include "verilated.h"

class Vaxi_sa16__Syms;

class Vaxi_sa16_group_processing_element_32 final : public VerilatedModule {
  public:
    ...
    VL_IN(io_inputC_0,17,0);
    VL_IN(io_inputC_1,17,0);
    VL_IN(io_inputC_2,17,0);
    VL_IN(io_inputC_3,17,0);
    VL_OUT(io_outputC_0,17,0);
    VL_OUT(io_outputC_1,17,0);
    VL_OUT(io_outputC_2,17,0);
    VL_OUT(io_outputC_3,17,0);
    IData/*17:0*/ __PVT__io_outputC_0_REG;
    IData/*17:0*/ __PVT__io_outputC_1_REG;
    IData/*17:0*/ __PVT__io_outputC_2_REG;
    IData/*17:0*/ __PVT__io_outputC_3_REG;
    IData/*18:0*/ __PVT__vectorProcessingElementVector_0_0__DOT__io_outputC_REG;
    IData/*18:0*/ __PVT__vectorProcessingElementVector_0_1__DOT__io_outputC_REG;
    IData/*18:0*/ __PVT__vectorProcessingElementVector_0_2__DOT__io_outputC_REG;
    IData/*18:0*/ __PVT__vectorProcessingElementVector_0_3__DOT__io_outputC_REG;

    // INTERNAL VARIABLES
    Vaxi_sa16__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vaxi_sa16_group_processing_element_32(Vaxi_sa16__Syms* symsp, const char* name);
    ~Vaxi_sa16_group_processing_element_32();
    VL_UNCOPYABLE(Vaxi_sa16_group_processing_element_32);
