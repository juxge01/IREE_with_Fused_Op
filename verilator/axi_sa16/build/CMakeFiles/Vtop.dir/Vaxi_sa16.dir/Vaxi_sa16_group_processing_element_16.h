...
#ifndef VERILATED_VAXI_SA16_GROUP_PROCESSING_ELEMENT_16_H_
#define VERILATED_VAXI_SA16_GROUP_PROCESSING_ELEMENT_16_H_  // guard

#include "verilated.h"

class Vaxi_sa16__Syms;

class Vaxi_sa16_group_processing_element_16 final : public VerilatedModule {
  public:
    ...
    VL_IN(io_inputC_0,16,0);
    VL_IN(io_inputC_1,16,0);
    VL_IN(io_inputC_2,16,0);
    VL_IN(io_inputC_3,16,0);
    VL_OUT(io_outputC_0,16,0);
    VL_OUT(io_outputC_1,16,0);
    VL_OUT(io_outputC_2,16,0);
    VL_OUT(io_outputC_3,16,0);
    IData/*16:0*/ __PVT__io_outputC_0_REG;
    IData/*16:0*/ __PVT__io_outputC_1_REG;
    IData/*16:0*/ __PVT__io_outputC_2_REG;
    IData/*16:0*/ __PVT__io_outputC_3_REG;
    IData/*17:0*/ __PVT__vectorProcessingElementVector_0_0__DOT__io_outputC_REG;
    IData/*17:0*/ __PVT__vectorProcessingElementVector_0_1__DOT__io_outputC_REG;
    IData/*17:0*/ __PVT__vectorProcessingElementVector_0_2__DOT__io_outputC_REG;
    IData/*17:0*/ __PVT__vectorProcessingElementVector_0_3__DOT__io_outputC_REG;

    // INTERNAL VARIABLES
    Vaxi_sa16__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vaxi_sa16_group_processing_element_16(Vaxi_sa16__Syms* symsp, const char* name);
    ~Vaxi_sa16_group_processing_element_16();
    VL_UNCOPYABLE(Vaxi_sa16_group_processing_element_16);
