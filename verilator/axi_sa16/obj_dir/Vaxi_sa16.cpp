...
Vaxi_sa16::Vaxi_sa16(VerilatedContext* _vcontextp__, const char* _vcname__)
    : VerilatedModel{*_vcontextp__}
    , vlSymsp{new Vaxi_sa16__Syms(contextp(), _vcname__, this)}
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
...
Vaxi_sa16::Vaxi_sa16(const char* _vcname__)
    : Vaxi_sa16(Verilated::threadContextp(), _vcname__)
{
}
...
void Vaxi_sa16___024root___eval_initial(Vaxi_sa16___024root* vlSelf);
void Vaxi_sa16___024root___eval_settle(Vaxi_sa16___024root* vlSelf);
...
#endif  // VL_DEBUG
void Vaxi_sa16___024root___final(Vaxi_sa16___024root* vlSelf);

static void _eval_initial_loop(Vaxi_sa16__Syms* __restrict vlSymsp) {
    vlSymsp->__Vm_didInit = true;
    Vaxi_sa16___024root___eval_initial(&(vlSymsp->TOP));
    // Evaluate till stable
    do {
        VL_DEBUG_IF(VL_DBG_MSGF("+ Initial loop\n"););
        Vaxi_sa16___024root___eval_settle(&(vlSymsp->TOP));
        Vaxi_sa16___024root___eval(&(vlSymsp->TOP));
    } while (0);
}

void Vaxi_sa16::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate Vaxi_sa16::eval_step\n"); );
#ifdef VL_DEBUG
    // Debug assertions
    Vaxi_sa16___024root___eval_debug_assertions(&(vlSymsp->TOP));
#endif  // VL_DEBUG
    // Initialize
...
const char* Vaxi_sa16::name() const {
    return vlSymsp->name();
}
...
VL_ATTR_COLD void Vaxi_sa16::final() {
    Vaxi_sa16___024root___final(&(vlSymsp->TOP));
}

//============================================================
// Implementations of abstract methods from VerilatedModel

const char* Vaxi_sa16::hierName() const { return vlSymsp->name(); }
const char* Vaxi_sa16::modelName() const { return "Vaxi_sa16"; }
unsigned Vaxi_sa16::threads() const { return 1; }
