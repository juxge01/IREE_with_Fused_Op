...
#ifndef VERILATED_VAXI_SA16_H_
#define VERILATED_VAXI_SA16_H_  // guard

#include "verilated.h"

class Vaxi_sa16__Syms;
class Vaxi_sa16___024root;

// This class is the main interface to the Verilated model
class Vaxi_sa16 VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    Vaxi_sa16___024root* const rootp;
    ...
    explicit Vaxi_sa16(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vaxi_sa16(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vaxi_sa16();
  private:
    VL_UNCOPYABLE(Vaxi_sa16);  ///< Copying not allowed
